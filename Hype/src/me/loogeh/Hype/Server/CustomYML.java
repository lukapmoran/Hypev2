...
public class CustomYML {
	...
	public CustomYML(String name) {
		...
		if(!customConfigFile.exists()) {
			try {
				...
				e.printStackTrace();
				Main.logger.log(Level.WARNING, "Custom YML > Failed to create file " + name);
			}
		}
	...
	public void save() {
		...
		try {
			...
			e.printStackTrace();
			Main.logger.log(Level.WARNING, "Custom YML > Failed to save file " + this.name);
		}
	}
